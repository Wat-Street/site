...
const Navbar = () => {
    ...
    return (
        <div className="border-b-[1px] border-[#262626] w-full h-16 px-4 sm:px-16 grid grid-cols-3 items-center fixed">
            ...
            {/* <div className="justify-self-end">Social Links</div> */}
        </div>
    );
};
